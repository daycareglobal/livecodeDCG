...
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('admin_assets'); ?>global/plugins/bootstrap-fileinput/bootstrap-fileinput.css"/>
<link href="<?php echo $this->config->item('admin_assets'); ?>admin/layout4/css/custom.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo $this->config->item('admin_assets'); ?>global/plugins/dropzone/css/dropzone.css" rel="stylesheet"/>
<link href="<?php echo $this->config->item('admin_assets'); ?>admin/pages/css/portfolio.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo $this->config->item('admin_assets'); ?>global/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet" type="text/css"/>
...
<!-- <link href="<?php echo $this->config->item('admin_assets'); ?>global/css/bootstrap-tagsinput.css" rel="stylesheet" type="text/css"/> -->
				...
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									<li>
										...
										<span class="photo">
										<img src="<?php echo $this->config->item('admin_assets'); ?>admin/layout3/img/avatar2.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
									...
									<li>
										<a href="inbox14c8.html?a=view">
										<span class="photo">
										<img src="<?php echo $this->config->item('admin_assets'); ?>admin/layout3/img/avatar3.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
									...
									<li>
										<a href="inbox14c8.html?a=view">
										<span class="photo">
										<img src="<?php echo $this->config->item('admin_assets'); ?>admin/layout3/img/avatar1.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
					...
					<li class="dropdown dropdown-user dropdown-dark">
						...
						<ul class="dropdown-menu dropdown-menu-default">
							...
							<!-- <li>
								<a href="<?php echo site_url('admin/website') ?>">
								<i class="icon-settings"></i> Website Setting
								</a>
							</li>
							<li class="divider">
							</li> -->

				...
				<?php echo form_open(current_url(), array('class' => 'form-horizontal ajax_form', 'autocomplete' => 'off'));?>
					<div class="form-body">
                    	...
                    	<div class="form-group form-md-line-input">
							<label for="form_control_title" class="control-label col-md-2">Business Name<span style="color:red">*</span></label>
							<div class="col-md-10">
								<?php echo form_input(array('placeholder' => 'Enter Business Name', 'id' => "business_name", 'name' => "business_name", 'class' => "form-control", 'value' => "$business_name")); ?>
						...
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-10">
								<select name="business_type_id[]" id="business_type_id" class="form-control select2 language_data" multiple style="height:40px">
							        <!-- <option value="">
								        <?php if (!empty($all_business_type)) { ?>
							        ...
							        <?php if(!empty($all_business_type)) {
							            	foreach ($all_business_type as $key => $value) 
								            {
									            ...
									            if ($selected_business_type) {
									            	...
									            	foreach ($selected_business_type as $k => $v) {

											            if($v->business_type_id == $value->id)
											            {
											            	$selected = 'selected';
											            }
									            	}

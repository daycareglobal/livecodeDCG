...
<div class="row">
  <div class="col-md-12">
    ...
    <?php if(isset($groups) && !empty($groups)) { ?>  
          ...
          <div class="portlet-title">
            <div class="row">
              <div class="col-md-6">
                <div class="caption font-red-sunglo">
                  <i class="fa fa-file-image"></i>
                  <span class="caption-subject bold font-purple-plum uppercase"><i class="fa fa-object-group"></i> Group List: <span class="language font-red-sunglo">Different Age Groups</span></span>
                </div>
              </div>          
            </div>        
          </div>
            ...
            <div class="form-body">
              <div class="form-group form-md-line-input">
                <table class="table table-striped table-bordered table-hover" id="sample_3">
                  ...
                  <tbody>
                    <?php foreach ($groups as $k => $value) { ?>
                      <tr>
                        <td><?php echo $value->from_month.' months -'.$value->to_month.' months'; ?></td>
                      </tr>
                    <?php }  ?>
                  </tbody>
                </table>
      ...
      <?php if(!empty($businessGroups)) { foreach ($businessGroups as $key => $value) { ?>
        <div class="portlet light">
          <div class="portlet-title">
            <div class="row">
              <div class="col-md-6">
                <div class="caption font-red-sunglo">
                  <i class="fa fa-file-image"></i>
                  <span class="caption-subject bold font-purple-plum uppercase"><i class="fa fa-object-group"></i> Group Name: <span class="language font-red-sunglo"><?php echo $value->from_month.'-'.$value->to_month; ?></span></span>
                </div>
              </div>          
            </div>        
          </div>
          ...
          <div class="portlet-body form">           
            <div class="form-body">
              <div class="form-group form-md-line-input">
                <?php if(isset($value->monthly_session_fees) && !empty($value->monthly_session_fees)) {  
                    foreach ($value->monthly_session_fees as $keys => $session) { ?>
                <table class="table table-striped table-bordered table-hover" id="sample_3">
                    <thead>
      ...
      <div class="portlet light">
          <div class="portlet-title">
            <div class="row">
              <div class="col-md-6">
                <div class="caption font-red-sunglo">
                  <i class="fa fa-file-image"></i>
                  <span class="caption-subject bold font-purple-plum uppercase"><i class="fa fa-calendar"></i> Sessions: <span class="language font-red-sunglo">Session list for same sets</span></span>
                </div>
              </div>          
            </div>        
          </div>
          ...
          <div class="portlet-body form">           
            <div class="form-body">
              ...
              <?php } else { ?>
                <center><div>Session list not found</div></center>
               <?php } ?>
              </div>
            </div>
          </div>
          ...
          <div class="portlet-title">
            <div class="row">
              <div class="col-md-6">
                <div class="caption font-red-sunglo">
                  <i class="fa fa-file-image"></i>
                  <span class="caption-subject bold font-purple-plum uppercase"><i class="fa fa-money"></i> Monthly fees: <span class="language font-red-sunglo">Monthly fees for same for sets</span></span>
                </div>
              </div>          
            </div>        
          </div>
          ...
          <div class="portlet-body form">           
            <div class="form-body">
              <div class="form-group form-md-line-input">
                ...
                <?php } } else { ?>
                <center><div>Monthly fees not found</div></center>
               <?php } ?>
              </div>
            </div>
          </div>

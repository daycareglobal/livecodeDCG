	...
	<div class="col-md-12">
		...
		<div class="portlet box grey-cascade">
			<div class="portlet-title">
				<div class="caption"><i class="fa fa-graduation-cap"></i>List Of Service Category</div>
			</div>
			<div class="portlet-body">
					...
					<div class="row">
						<div class="col-md-12">	
							...
							<div class="btn-group tooltips" data-original-title="ADD NEW">
								<a href="<?php echo base_url('admin/service_category/add'); ?>" class="btn green add_link">ADD NEW<i class="fa fa-plus"></i></a>
							</div>
							...
							<?php foreach ($records as $record) { ?>
								<tr>
									...
									<!-- <td>
										...
										<?php } ?>
											...
											<ul class="dropdown-menu" role="menu" style="margin-top:-50px">
												<li><a data-id="<?php echo $record->id; ?>" data-url="<?php echo site_url('admin/service_category/changeStatus'); ?>" data-status="Active" onClick="changeStatusCommon(this)">Active</a></li>
												<li><a data-id="<?php echo $record->id; ?>" data-url="<?php echo site_url('admin/service_category/changeStatus'); ?>" data-status="Inactive" onClick="changeStatusCommon(this)">Inactive</a></li>
											</ul>
									...
									<td class="text-center">	
										<a href="<?php echo base_url('admin/service_category/update/'.$record->id) ?>" class="btn purple tooltips" data-original-title="Update this record" data-placement="top" data-container="body"><i class="fa fa-pencil"></i></a>
										
										<a href="<?php echo base_url('admin/service_category/view/'.$record->id) ?>" class="btn yellow tooltips" data-original-title="View this record" data-placement="top" data-container="body"><i class="fa fa-eye"></i></a>
										
										<a data-toggle="modal" data-id="<?php echo $record->id; ?>" data-url="<?php echo base_url('admin/service_category/delete'); ?>" class="btn btn-danger tooltips" onClick="deleteRecord(this);" data-original-title="Remove this record" data-placement="top" data-container="body"><i class="fa fa-remove"></i>
										</a> 
									</td>
								</tr>								
							<?php } ?>

				...
				<?php echo form_open(current_url(), array('class' => 'form-horizontal ajax_form', 'autocomplete' => 'off'));?>
					<div class="form-body">
                    	...
                    	<div class="form-group form-md-line-input">
							<label for="form_control_title" class="control-label col-md-2">Service Name<span style="color:red">*</span></label>
							<div class="col-md-10">
								<?php echo form_input(array('placeholder' => 'Enter Service Category Name', 'id' => "name", 'name' => "name", 'class' => "form-control", 'value' => "$name")); ?>
						...
						<div class="form-actions noborder">
							<div class="row">
								...
								<a href="<?php echo base_url('admin/service_category'); ?>" class="btn default">Cancel</a>
							</div>
							</div>
						</div>
					</form>

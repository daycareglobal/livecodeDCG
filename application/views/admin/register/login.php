...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form ajax_form" action="<?php echo site_url('admin/login'); ?>" method="post">
		<h3 class="form-title">Login to your account</h3>
		<div class="alert alert-danger display-hide">
			<button class="close" data-close="alert"></button>
			<span>
			Enter any e-mail address and password. </span>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="on" placeholder="E-mail Address" name="email"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="forget-password">
			...
			<p>
				no worries, click <a href="<?php echo site_url('admin/forgot-password'); ?>" id="forget-password">
				here </a>

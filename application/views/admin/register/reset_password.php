	...
	<form class="forgot-form ajax_form" action="" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="New Password" name="new_password"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-lock"></i>
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-enter Password" name="confirm_password"/>
			</div>
		</div>			
		...
		<div class="forget-password">
			<span>Click <a href="<?php echo site_url('admin/login'); ?>" id="forget-password">

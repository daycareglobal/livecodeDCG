...
class Instamojo {
    ...
    protected $curl;
    protected $endpoint = 'https://www.test.instamojo.com/api/1.1/';
    protected $api_key = 'test_b6b8b1ca8379e7b3be24bd1b74f';
    protected $auth_token = 'test_f2c0de26d1d1e1c8aa71ed886f6';

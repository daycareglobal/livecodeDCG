...
class Curricular_activities_model extends CI_Model {
	function __construct() {
		parent::__construct();
		$this->table = 'tbl_carricular_activities';
	}
    ...
    function get_activity_request() {
        ...
        $this->db->join('tbl_user_service_detail', 'tbl_user_service_detail.id = tbl_user_own_activity.user_service_detail_id');
    ...
    function add_request($data) {        
        $this->db->insert('tbl_user_curricular_activity', $data);
        return $this->db->insert_id();
    }
